	...
	<div class="row">
      <div class="col-md-7">
        <div class="well well-sm">
          <form:form class="form-horizontal" action="/ECommerce/editsave1" method="post">
          <fieldset>
            ...
            <div class="form-group">
              <!-- <label class="col-md-4 control-label text-left" for="id">Category ID :</label>
               --><div class="col-md-8">
                <form:hidden id="categoryID" path="categoryID" placeholder="Category ID" class="form-control"/>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="col-md-12 text-center">
                <button id="submit" type="submit" class="btn btn-danger btn-primary btn-lg ">Update</button>
              </div>
            </div>
          </fieldset>
          </form:form>
